            ...
            switch (browser) {
                ...
                case "remote_chrome":
                    try {
                        ...
                        DriverPool.set(new RemoteWebDriver(new URL("enter your remote selenium grid link"), chromeOptions));
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                    break;
                case "remote_firefox":
                    try {
                        ...
                        DriverPool.set(new RemoteWebDriver(new URL("enter your remote selenium grid link"), firefoxOptions));
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                    break;
